...
tf.app.flags.DEFINE_boolean("layer_norm", True, "If `True`, layer normalization will be applied.")
...
tf.app.flags.DEFINE_integer("sequence_length", 100, "RNN sequence length.")
